...
public class Allmembers extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("All Member's List");
    ...
    private void txtsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearchKeyReleased
        // TODO add your handling code here:
         try{
            ...
            String sql=" SELECT `mid`, `name`, `nic`,`date` ,`gender`, `address`, `email`, `mobile`, `mtype` FROM `addmember` WHERE name LIKE '%"+txtsearch.getText()+"%'";
